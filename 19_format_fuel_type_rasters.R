...
ft17p <- project(ft17,raster_template, method = "mode")
names(ft17p)<- "FT_2017"
...
ft18p <- project(ft18,raster_template , method = "mode")
names(ft18p)<- "FT_2018"
...
ft20 <- project(ft20,raster_template , method = "mode")
...
terra::writeRaster(ordered_stack, fs::path(out_dir, "ft_bumo_2017_20204_mode.tif"))
